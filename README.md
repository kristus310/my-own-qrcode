...
### GoCipher is mine own version of QRCode made from scratch.
 ...
 - The name, *GoCipher* is made up from:
    - *Go* - It was written in Golang
    - *Cipher* - Because I am "ciphering" the users URL/data
    - but also it is a pun to Golangs mascot, *Gopher* :D